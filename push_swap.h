...
/*   Updated: 2026/01/28 21:15:19 by moamhouc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				free_allocated(char **args, int *numbers, t_stack **a,
						t_stack **b);
...
// bonus
int					swap_check(char *move, t_stack **stack_a,
						t_stack **stack_b);
int					ft_strcmp(char *s1, char *s2);
int					rotate_check(char *move, t_stack **stack_a,
						t_stack **stack_b);
int					reverse_rotate_check(char *move, t_stack **stack_a,
						t_stack **stack_b);
int					push_check(char *move, t_stack **stack_a,
						t_stack **stack_b);
